                ...
                if event.type == pygame.KEYDOWN:
                    if self.scene == "game":
                        if event.key == pygame.K_DOWN:
                            self.current_scene.spaceship.pra_baixo(self.speed_ship)
                        elif event.key == pygame.K_UP:
                            self.current_scene.spaceship.pra_cima(self.speed_ship)
                        elif event.key == pygame.K_LEFT:
                            self.current_scene.spaceship.pra_esquerda(self.speed_ship)
                        elif event.key == pygame.K_RIGHT:
                            self.current_scene.spaceship.pra_direita(self.speed_ship)
